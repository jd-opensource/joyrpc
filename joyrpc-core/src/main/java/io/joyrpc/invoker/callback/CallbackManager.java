package io.joyrpc.invoker.callback;
...
import io.joyrpc.invoker.option.AbstractInterfaceOption;
import io.joyrpc.invoker.option.AbstractMethodOption;
...
import static io.joyrpc.util.thread.ThreadPoolFactory.QUEUE_FUNCTION;
...
public class CallbackManager implements Closeable {
    ...
    protected static class ConsumerCallbackContainer extends AbstractCallbackContainer<ConsumerCallbackInvoker> {
        ...
        public void addCallback(final RequestMessage<Invocation> request, final ChannelTransport transport) {
            CallbackOption meta = request.getOption().getCallback();
            if (meta == null) {
                return;
            }
            Invocation invocation = request.getPayLoad();
            Object[] args = invocation.getArgs();
            Object callbackArg = args[meta.getIndex()];
            //和callback对象绑定
    ...
    protected static class ProducerCallbackContainer extends AbstractCallbackContainer<ProducerCallbackInvoker> {
        ...
        public void addCallback(final RequestMessage<Invocation> request, final ChannelTransport transport) {
            ...
            invocation.getArgs()[meta.getIndex()] = handler.callback;
        }
