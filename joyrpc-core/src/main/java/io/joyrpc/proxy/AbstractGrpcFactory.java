...
public abstract class AbstractGrpcFactory implements GrpcFactory {
    ...
    protected String getRequestClassName(final Class clz, final Method method) {
        ...
        StringBuilder builder = new StringBuilder(30).append(Character.toUpperCase(methodName.charAt(0)))
                .append(methodName.substring(1)).append(REQUEST_SUFFIX);
    ...
    protected String getResponseClassName(final Class clz, final Method method) {
        String methodName = method.getName();
        StringBuilder builder = new StringBuilder(50).append(clz.getName()).append('$').append(Character.toUpperCase(methodName.charAt(0)))
                .append(methodName.substring(1)).append(RESPONSE_SUFFIX);
        return builder.toString();
    }
