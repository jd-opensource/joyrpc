...
public class BootGroupClient {

    public static void main(String[] args) {
        System.setProperty("spring.profiles.active", "group-client");
        ConfigurableApplicationContext run = SpringApplication.run(BootGroupClient.class, args);
