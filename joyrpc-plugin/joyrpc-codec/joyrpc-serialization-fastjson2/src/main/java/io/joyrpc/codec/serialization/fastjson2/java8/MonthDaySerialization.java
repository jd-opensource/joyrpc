 ...
 * 月日序列化
 */
public class MonthDaySerialization extends AbstractSerialization<MonthDay> {
    ...
    @Override
    protected MonthDay doRead(final JSONReader jsonReader, final Type fieldType, final Object fieldName, final long features) {
