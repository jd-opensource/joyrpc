 ...
 * 年月序列化
 */
public class YearMonthSerialization extends AbstractSerialization<YearMonth> {
    ...
    @Override
    protected YearMonth doRead(final JSONReader jsonReader, final Type fieldType, final Object fieldName, final long features) {
