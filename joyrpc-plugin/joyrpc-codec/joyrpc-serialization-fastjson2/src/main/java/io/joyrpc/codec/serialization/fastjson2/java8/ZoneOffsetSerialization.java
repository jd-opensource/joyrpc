 ...
 * ZoneOffset序列化
 */
public class ZoneOffsetSerialization extends AbstractSerialization<ZoneOffset> {
    ...
    @Override
    protected ZoneOffset doRead(final JSONReader jsonReader, final Type fieldType, final Object fieldName, final long features) {
