...
public abstract class AbstractDubboProtocol extends AbstractProtocol {
    ...
    static {
        ...
        SERIALIZATIONS_TO_JOY[JAVA_SERIALIZATION_ID] = (byte) Serialization.DUBBO_JAVA_ID;
        ...
        SERIALIZATIONS_TO_DUBBO[(byte) Serialization.DUBBO_JAVA_ID] = JAVA_SERIALIZATION_ID;
