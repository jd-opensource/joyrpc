...
public class DubboResponseErrorPayloadSerializer implements AutowiredObjectSerializer {
    ...
    public boolean willHandleClass(final Class cl) {
        return cl == DubboResponseErrorPayload.class;
    }
    ...
    public Object instantiate(final Class objectClass, final FSTObjectInput fstObjectInput,
        ...
        return new DubboResponseErrorPayload();
    }
